// ISO 3166-1 alpha-2 country list (code + English display name), generated
// via Intl.DisplayNames. Static reference data for the onboarding country
// picker (src/app/welcome) and validation.
